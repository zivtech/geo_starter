...
// 1.1.0 is the additive content-model contract; 1.2.0 is the next recipe
// release that will carry it. Do not point a changed schema at the 1.1.0
// release artifact, which did not contain Article publication dates.
$schemaVersion = '1.1.0';
